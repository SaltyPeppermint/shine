...
lazy val riseAndShine = (project in file("."))
  ...
  .settings(
    ...
    version := "1.0",
    javaOptions ++= Seq(
      "-Djava.library.path=lib/yacx/build:lib/executor/lib/Executor/build",
      "-XX:+HeapDumpOnOutOfMemoryError",
      "-XX:HeapDumpPath=/tmp/rise-and-shine.hprof",
      "-DexecuteCudaTests=false",
      "-Xss26m",
      "-Xmx2048m"
    ),
    commonSettings,
...
lazy val meta = (project in file("meta"))
  .settings(
    ...
    libraryDependencies += "com.lihaoyi" %% "scalaparse" % "2.3.2",
